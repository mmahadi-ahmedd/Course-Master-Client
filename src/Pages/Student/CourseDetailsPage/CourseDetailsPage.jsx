...
const CourseDetailsPage = () => {
    ...
    const { allCourses, calculateRating, calculateChapterTime,
        ...
        calcultaeNoOfLectures, currency } = useContext(AppContext)
    ...
    return courseData ? (
        <>
            <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-[30px] pt-20 text-left' >

                <div className='absolute top-0 left-0 w-full section-height z-[-1] bg-gradient-to-b from-cyan-100/70' >
                                ...
                                <div key={index} className='border border-gray-300 bg-white mb-2 rounded' >
                                    <div className='flex items-center justify-between px-4 py-3 cursor-pointer select-none' onClick={() => toggleSection(index)} >
                                        <div className='flex items-center gap-2' >
                                            <img className={`transform transform-transform ${openSections[index] ? 'rotate-180' : ''}`} src={assets.down_arrow_icon} alt="arrow icon" />
                ...
                <div className='mas-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]' >
                    ...
                    <div className='p-5' >
                        ...
                        <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500' >
                            ...
                            <div className='flex items-center gap-1' >
                                ...
                                <p>{calcultaeNoOfLectures(courseData)} lessons </p>
                            </div>
                            ...
                            <div className='pt-6' >
                                ...
                                <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500' >
                                    ...
                                    <li>Step-by-step hand-on project code.</li>
