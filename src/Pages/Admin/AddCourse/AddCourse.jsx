...
const AddCourse = () => {
    ...
    const [lectureDettails, setLectureDettails] = useState(
        {
            lectureTitle: '',
            lectureDuration: '',
            lectureUrl: '',
    ...
    return (
        <div className='h-screen text-black overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0' >
                ...
                <div>
                    {
                        chapters.map((chapter, chapterIndex)=>(
                            <div key={chapterIndex} className='bg-white border rounded-lg mb-4' >
                                <div className='flex justify-betwen items-center p-4 border-b' >
                            ...
                            <div className='fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity 50' >
                                <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80' >
                                    ...
                                    <div className='mb-2'>
                                        ...
                                        value={lectureDettails.lectureTitle}
                                        onChange={(e)=>setLectureDettails({...lectureDettails, lectureTitle: e.target.value})} />
                                    </div>
                                    <div className='mb-2'>
                                        ...
                                        type="number"
                                        className='mt-1 block w-full border rounded py-1 px-2'
                                        value={lectureDettails.lectureDuration}
                                        onChange={(e)=>setLectureDettails({...lectureDettails, lectureDuration: e.target.value})} />
                                    </div>
                                    <div className='mb-2'>
                                        <p>Lecture URL</p>
                                        <input 
                                        type="text"
                                        className='mt-1 block w-full border rounded py-1 px-2'
                                        value={lectureDettails.lectureUrl}
                                        onChange={(e)=>setLectureDettails({...lectureDettails, lectureUrl: e.target.value})} />
                                    </div>
                                    <div className='mb-2'>
                                        <p>Is Preview Free ?</p>
                                        <input 
                                        ...
                                        value={lectureDettails.isPreviewFree}
                                        onChange={(e)=>setLectureDettails({...lectureDettails, isPreviewFree: e.target.value})} />
                                    </div>
                 ...
                 <button type='submit' className='w-max bg-black text-white px-8 py-2.
                 5 rounded my-4' >ADD</button>
